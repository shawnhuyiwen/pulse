...
public:
  ...
  static bool SerializeToString(const SEAnesthesiaMachine& src, std::string& output, SerializationMode m);
  static bool SerializeToFile(const SEAnesthesiaMachine& src, const std::string& filename, SerializationMode m);
  static bool SerializeFromString(const std::string& src, SEAnesthesiaMachine& dst, SerializationMode m);
  static bool SerializeFromFile(const std::string& filename, SEAnesthesiaMachine& dst, SerializationMode m);
