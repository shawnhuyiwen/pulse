...
set(Protobuf_SELECT_VERSION "3.18.0" CACHE STRING "Select the  version of ProtoBuf to build.")
set_property(CACHE Protobuf_SELECT_VERSION PROPERTY STRINGS "3.18.0" "3.15.8" "3.10.0")
set(Protobuf_version ${Protobuf_SELECT_VERSION})

if (Protobuf_SELECT_VERSION VERSION_EQUAL 3.18.0)# Latest, Can change
...
elseif(${protobuf_VERSION} STREQUAL "3.15.8") # Requested by DarkSlope
  set(protobuf_URL "https://github.com/protocolbuffers/protobuf/releases/download/v3.15.8/protobuf-all-3.15.8.zip")
  set(protobuf_URL_MD5 "5249754276f08be7fef1421f418c1e70")
elseif (Protobuf_SELECT_VERSION VERSION_EQUAL 3.10.0)# Requested by Swansea for compatibility with YarnSpinner v1.2.6
...
elseif(Protobuf_SELECT_VERSION)
