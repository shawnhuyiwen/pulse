...
void PulseConfiguration::Initialize(const std::string& data_dir)
{
  ...
  GetECGInterpolator().SerializeFromFile(data_dir+"/ecg/StandardECG.pba",ASCII,&GetTimeStep());
  GetDynamicStabilization().SerializeFromFile(data_dir+"/config/DynamicStabilization.pba",ASCII);
  //GetTimedStabilization().SerializeFromFile(data_dir+"/config/TimedStabilization.pba",ASCII);
  ...
  GetInitialEnvironmentalConditions().SerializeFromFile(data_dir+"/environments/Standard.pba",ASCII);
  ...
  GetDefaultStomachContents().SerializeFromFile(data_dir+"/nutrition/Standard.pba",ASCII);// Refs are in the data spreadsheet
