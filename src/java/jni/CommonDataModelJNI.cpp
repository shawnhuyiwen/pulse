...
extern "C"
JNIEXPORT void JNICALL Java_pulse_utilities_jniBridge_nativeInitialize(JNIEnv *env, jobject obj)
{
  Logger::Initialize();
}

extern "C"
JNIEXPORT void JNICALL Java_pulse_utilities_jniBridge_nativeDeinitialize(JNIEnv *env, jobject obj)
{
...
extern "C"
JNIEXPORT jboolean JNICALL Java_pulse_utilities_UnitConverter_nativeIsCompatibleWithUnit(JNIEnv *env, jobject obj, jstring testUnit, jstring unit)
{ 
...
extern "C"
JNIEXPORT jboolean JNICALL Java_pulse_utilities_UnitConverter_nativeIsOfQuantityType(JNIEnv *env, jobject obj, jstring templateUnit, jstring unit)
{ 
  const char* unitBuf = env->GetStringUTFChars(unit, JNI_FALSE);
...
extern "C"
JNIEXPORT jboolean JNICALL Java_pulse_utilities_UnitConverter_nativeIsCompatibleWithUnitList(JNIEnv *env, jobject obj, jobjectArray list, jstring unit)
{ 
  if(list==nullptr)
    return JNI_FALSE;
...
extern "C"
JNIEXPORT jboolean JNICALL Java_pulse_utilities_UnitConverter_nativeIsOfQuantityTypes(JNIEnv *env, jobject obj, jobjectArray templateUnits, jstring unit)
{ 
...
// basic conversion
extern "C"
JNIEXPORT jdouble JNICALL Java_pulse_utilities_UnitConverter_nativeConvert(JNIEnv *env, jobject obj, jdouble val, jstring unit_from, jstring unit_to)
{ 
...
JNIEXPORT jboolean JNICALL Java_pulse_utilities_UnitConverter_nativeGenerateUnitConverterData
