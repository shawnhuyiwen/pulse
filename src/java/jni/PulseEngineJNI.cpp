...
{ 
  ...
  PulseEngineJNI *engineJNI = new PulseEngineJNI((pulse::engine::eModelType)model, dataDirStr);
...
PulseEngineJNI::PulseEngineJNI(pulse::engine::eModelType t, const std::string& dataDir) : PulseEngineThunk(t,dataDir)
{
  Reset();
}
