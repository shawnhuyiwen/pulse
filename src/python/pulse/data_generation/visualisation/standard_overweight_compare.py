...
IN_DIR = "standard_male_clean.csv"
# Read the CSV file
standard_male_df = pd.read_csv(IN_DIR)

# Extract data from the DataFrame
time_steps = standard_male_df['Time(s)'] / 60  # Convert time to minutes
systolic_pressure = standard_male_df['SystolicArterialPressure(mmHg)']
diastolic_pressure = standard_male_df['DiastolicArterialPressure(mmHg)']
heart_rate = standard_male_df['HeartRate(1/min)']
plasma_concentration = standard_male_df['Propofol-PlasmaConcentration(ug/L)']
