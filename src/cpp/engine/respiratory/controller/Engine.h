...
//--------------------------------------------------------------------------------------------------
class PULSE_DECL RespiratoryEngine : public PhysiologyEngine
{
  friend class LSEngine;
public:
  RespiratoryEngine(Logger* logger=nullptr);
  virtual ~RespiratoryEngine();
  ...
  PulseController* GetController() { return m_Controller; }
protected:
