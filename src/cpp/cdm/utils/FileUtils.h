...
bool CDM_DECL IsRelativePath(std::string const& path);
...
void CDM_DECL Trim(std::string& s);
void CDM_DECL TrimFront(std::string& s);
void CDM_DECL TrimBack(std::string& s);
