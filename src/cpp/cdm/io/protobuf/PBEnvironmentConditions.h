...
public:
  ...
  static void Load(const CDM_BIND::InitialEnvironmentalConditionsData& src, SEInitialEnvironmentalConditions& dst);
  static CDM_BIND::InitialEnvironmentalConditionsData* Unload(const SEInitialEnvironmentalConditions& src);
  static void Serialize(const CDM_BIND::InitialEnvironmentalConditionsData& src, SEInitialEnvironmentalConditions& dst);
  static void Serialize(const SEInitialEnvironmentalConditions& src, CDM_BIND::InitialEnvironmentalConditionsData& dst);
  static void Copy(const SEInitialEnvironmentalConditions& src, SEInitialEnvironmentalConditions& dst);
