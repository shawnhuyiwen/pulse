...
CDM_BIND_DECL2(SegmentValidationTargetList)
...
public:
  ...
  static void Load(const CDM_BIND::SegmentValidationTargetListData& src, std::vector<SESegmentValidationTarget*>& dst);
  static void Serialize(const CDM_BIND::SegmentValidationTargetListData& src, std::vector<SESegmentValidationTarget*>& dst);
  ...
  static CDM_BIND::SegmentValidationTargetListData* Unload(const std::vector<const SESegmentValidationTarget*>& src);
  static void Serialize(const std::vector<const SESegmentValidationTarget*>& src, CDM_BIND::SegmentValidationTargetListData& dst);
